...
describe('Initial Tests', () => {
  ...
  beforeEach(async () => {
        ...
        SavedSearchesService,
        {
          ...
          useValue: {
            getRepository: jest.fn((entity) => {
              if (entity === SavedSearch) return mockSavedSearchRepo;
    ...
    savedSearchRepository = mockSavedSearchRepo as any;
    listingRepository = { findOne: jest.fn() } as any;
  });
  ...
  describe('findMatchingSavedSearches', () => {
    ...
    it('should throw NotFoundException when listing not found', async () => {
      await expect(service.findMatchingSavedSearches(null as any))
        .rejects
