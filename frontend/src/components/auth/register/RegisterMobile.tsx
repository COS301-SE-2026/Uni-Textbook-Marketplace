                        ...
                        <div className="space-y-4">
                            ...
                            <div style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem" }}>
                                ...
                                <label htmlFor="terms-mobile" style={{ fontSize: "0.78rem", color: "#3a3a3a", cursor: "pointer" }}>
                                    I agree to the{" "}
                                    <a href="#" className="text-primary" style={{ fontWeight: 500 }}>Terms of Service</a>
                                    {" "}and{" "}
                                    <a href="#" className="text-primary" style={{ fontWeight: 500 }}>Privacy Policy</a>
                                </label>
                            </div>
                                ...
                                {[1, 2, 3, 4].map((n) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            fontSize: "0.65rem",
                                            fontWeight: 700,
                                            color: n === step ? "#ffffff" : n < step ? "#00B4D8" : "#9ca3af",
