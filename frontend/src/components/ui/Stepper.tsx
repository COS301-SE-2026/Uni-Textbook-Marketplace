                ...
                return (
                    <React.Fragment key={stepNum}>
                        <div className="flex flex-col items-center min-w-[60px]">
                            <div
                                className={`w-10 h-10 rounded-full border-2 flex items-center justify-center text-sm font-semibold transition-all ${circleClass}`}
                            >
                                {done ? <Check className="w-5 h-5" /> : stepNum}
                            </div>
                            <span
                                className={`text-[10px] text-center leading-tight mt-2 whitespace-pre-line ${labelClass}`}
                            >
                                {label}
                            </span>
                        </div>
